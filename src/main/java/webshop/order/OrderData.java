...
public class OrderData {
    ...
    public OrderData(long orderId, String username, LocalDateTime orderTime, OrderStatus orderStatus,
                     String shippingAddress, long sumOrderPrice, int sumOrderPieces) {
